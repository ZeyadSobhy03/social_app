...
class ThemeManger {
  static ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      iconTheme: IconThemeData(color: ColorManger.grey61),
    ...
    iconButtonTheme: IconButtonThemeData(
      style: IconButton.styleFrom(foregroundColor: ColorManger.grey61),
    ),
    iconTheme: IconThemeData(color: ColorManger.grey61),
    textTheme: TextTheme(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        ...
        borderSide: BorderSide(color: ColorManger.lightGrey, width: 2.w),
      ),
    ...
    drawerTheme: DrawerThemeData(backgroundColor: ColorManger.white),
  );
  static ThemeData darkTheme = ThemeData(
    ...
    iconTheme: IconThemeData(color: ColorManger.grey9E),
    appBarTheme: AppBarTheme(
      centerTitle: true,
      backgroundColor: ColorManger.black12,
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12.r),
        borderSide: BorderSide(color: ColorManger.darkGrey, width: 2.w),
      ),
      errorBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12.r),
        borderSide: BorderSide(color: ColorManger.red, width: 2.w),
    ...
    textSelectionTheme: TextSelectionThemeData(cursorColor: ColorManger.white),
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
    ...
    drawerTheme: DrawerThemeData(backgroundColor: ColorManger.black21),
  );
}
